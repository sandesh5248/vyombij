                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-16 lg:gap-24">
                    <div>
                        ...
                        <p className="text-[17px] text-slate-600 leading-relaxed font-medium mb-6">
                            Limited Liability Partnership (LLP) Registration is a business structure that combines the benefits of a partnership with the advantages of a corporate entity. The core feature of an LLP is that partners have limited liability protection. Partners are not personally responsible for business debts beyond their agreed contribution to the LLP.                        </p>
                        <p className="text-[17px] text-slate-600 leading-relaxed font-medium mb-6">
                            LLP registration provides operational flexibility similar to a partnership while offering liability protection similar to a company. LLPs are widely preferred by professionals such as lawyers, consultants, and accountants. They are also suitable for startups and businesses across various industries. In India, LLPs are governed by the Limited Liability Partnership Act and related regulations.                        </p>
                        <p className="text-[17px] text-slate-600 leading-relaxed font-medium mb-6">
                            Consult our LLP experts today for a simplified registration process and begin your journey in India’s growing startup ecosystem.                        </p>
                    </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 w-full">
                ...
                <div className="lg:sticky lg:top-28 h-fit self-start">
                    ...
                    <p className="text-[17px] text-slate-600 leading-relaxed font-medium mb-8">
                        LLP registration in India offers benefits such as limited liability protection, operational flexibility, and reduced compliance requirements. These advantages make LLPs an ideal structure for startups, professionals, and small businesses.                    </p>
                    <div className="mt-10">
                        <img
                ...
                <div className="space-y-6">
                    {[
                        { title: "Limited Liability", desc: "One key benefit of an LLP is limited liability protection, meaning partners' personal assets are protected from business debts. Partners are also protected from liability arising from the actions of other partners." },
                        { title: "Separate Entity", desc: "An LLP is legally separate from its partners. It has its own legal identity independent of its partners. The LLP can own assets, sign contracts, and take legal action in its own name." },
                        { title: "Flexibility", desc: "LLPs provide flexibility in management and operational structure. Partners can decide the internal structure based on business requirements. Since the LLP Agreement governs the rights and duties of the partners, these can be personalized to suit the business needs." },
                        { title: "Marginal Compliance", desc: "Compared to companies, LLPs have fewer compliance requirements. Annual filings and regulatory processes are simpler and easier to maintain." },
                        { title: "Tax Benefits", desc: "LLPs are taxed similarly to partnership firms and are not subject to corporate taxation. Profits are distributed to partners who pay tax individually, which may help reduce overall tax burden." },
                        { title: "Permanent Succession", desc: "An LLP has perpetual succession. Changes in partners such as retirement or death do not affect the existence of the LLP. LLPs continue to exist until the business is wrapped up or dissolved by the provisions of the Limited Liability Partnership Registration Act." },
                        { title: "No Min Capital", desc: "LLPs are not required to maintain a minimum capital at the time of incorporation. Partners can contribute capital based on their mutual agreement." },
...
const LLPEligibility = () => {
    const list = [
        { title: "Minimum Number of Partners", desc: "At least two partners are required to form an LLP." },
        { title: "Designated Partners", desc: "A minimum of two designated partners is required, and one must be an Indian resident." },
        { title: "Digital Signature Certificate (DSC)", desc: "Designated partners must obtain a Digital Signature Certificate to file online forms." },
        { title: "Registered Office", desc: "The LLP must have a registered office address in India with valid address proof." },
        ...
        <section className="w-full py-12 bg-white">
            <div className="max-w-6xl mx-auto px-6 lg:px-12">
                ...
                <p className="text-[17px] text-slate-600 leading-relaxed mb-8">
                    The following documents are required for partners and the registered office address.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {list.map((item, i) => (
                        <div key={i} className="flex gap-3 p-4 bg-[#e6f0fa] rounded-xl">
...
const LLPProcessSection = () => {
    const steps = [
        { title: "DSC & DPIN", desc: "Apply for Digital Signature Certificates and Designated Partner Identification Numbers." },
        { title: "Name Approval", desc: "Reserve the LLP name using the RUN-LLP service on the MCA portal." },
        { title: "FiLLiP Filing", desc: "File the FiLLiP form with the Ministry of Corporate Affairs for incorporation approval." },
        { title: "LLP Agreement", desc: "Prepare and file the LLP Agreement within 30 days after incorporation." },
        { title: "Compliance Setup", desc: "Complete compliance setup and open the LLP’s current bank account." }
    ];
    return (
            ...
            <div className="max-w-6xl mx-auto px-6">
                <div className="text-center mb-8">
                    ...
                    <p className="text-[16px] text-slate-600 max-w-3xl mx-auto leading-relaxed">
                        LLP registration offers a flexible business structure with limited liability protection and simplified compliance requirements.
                    </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
